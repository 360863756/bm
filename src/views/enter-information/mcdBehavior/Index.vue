<template>
    <div class="mcdBehavior">
        <div class="mcdBehavior-content">
        <el-form :model="formData">
             <table border="1">
                <tbody>
                    <tr>
                    <td><span class="pydocx-center"><span class="pydocx-insert"><strong>观察项目</strong></span></span></td>
                    <td><span class="pydocx-center"><span class="pydocx-insert"><strong>行为状况</strong></span></span></td>
                    </tr>
                    <tr>
  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      if (errcode === 0) {
        ...
        let res = await this.$api.mcd.updateLbstate(options);
        if (res.errcode === 0) {
          this.$router.push({
