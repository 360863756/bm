  ...
  <div class="platform">
    <title-panel>
      <template slot="header-append">
        <div class="header-content"><p><span></span><span></span><span></span><span></span></p>
        ...
        <div class="left_footer">
          <dv-border-box-8 :reverse="true" :color="['#1680FF']" :dur='7'>
            <title-panel>
              ...
              <traitement-grade :key="traitementgradeData.pgrs" :traitementgradeData="traitementgradeData"></traitement-grade>
            </title-panel>
          </dv-border-box-8>
        </div>
      </div>
        ...
        <div class="right_section">
          <dv-border-box-8 :reverse="true" :color="['#1680FF']" :dur='11'>
            <title-panel>
              ...
              <face-recognition :key="facerecognitionData.zmqxcs" :facerecognitionData='facerecognitionData'></face-recognition>
            </title-panel>
          </dv-border-box-8>
        </div>
...
import AssesmentEcharts from '../home/components/AssesmentEcharts.vue';
import TraitementGrade from '../home/components/TraitementGrade.vue';
import RankingList from '../home/components/RankingList.vue';
import SwiperList from '../home/components/SwiperList.vue';
import DengriousPeople from '../home/components/DengriousPeople.vue';
import FaceRecognition from '../home/components/FaceRecognition.vue';
...
export default {
  ...
  computed: {
    ...
    traitementgradeData() {
      let { ygrs, pgrs, kgrs, kcrs } = this.allData;
      return {
        ygrs, pgrs, kgrs, kcrs
      };
    },
    facerecognitionData() {
      let { zmqxcs, zmqxzb, fmqxcs, fmqxzb } = this.allData;
      return {
        zmqxcs, zmqxzb, fmqxcs, fmqxzb
      };
    },
    swiperListData() {
      let { dtcsyjrs, gwcsyjrs } = this.allData;
      return {
        dtcsyjrs, gwcsyjrs
      };
    }
  ...
  methods: {
    async getData() {
      let { data, errcode } = await this.$api.platform.getIndexData();
      if (errcode === 0) {
        this.allData = data;
      }
    },
